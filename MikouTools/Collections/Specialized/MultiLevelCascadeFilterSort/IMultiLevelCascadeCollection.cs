...
namespace MikouTools.Collections.Specialized.MultiLevelCascadeFilterSort
{
        ...
        where TFiltered : IMultiLevelCascadeFilteredView<FilterKey, ItemValue, TFiltered>
    {
        ...
        /// </summary>
        void AddFilterView(FilterKey filterKey, Func<ItemValue, bool>? filter = null, IComparer<ItemValue>? comparer = null);

        /// <summary>
        /// 指定したフィルターキーでフィルタービューを追加します。（Comparison 版）
        /// </summary>
        void AddFilterView(FilterKey filterKey, Func<ItemValue, bool>? filter = null, Comparison<ItemValue>? comparison = null);
